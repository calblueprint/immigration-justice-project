...
import { LimitedCaseAssignment, Interpretation, DocumentTranslation, CaseListing } from '@/types/schema';
import {Body, CardColumn, CaseDetailsContainer} from '../cases/styles';

const LCAinfo = {
  id: "099644df-c7ef-4eef-bd3b-76196da69886",
  title: "LCA",
  summary: "CL has asylum claim due to persecution that happened 15+ year ago; since 1 yr bar will likely apply this will be withholding/CAT only. CL was threatened and attempted kidnapped/murdered (friend who was supposed to pick him up that day was in fact murdered b/c cartel though CL was also in the vehicle driven by friend) by local cartel group in Cuernavaca Morelos Mexico because he was in a relationship with a woman who was 'claimed' by a younger member of the cartel group. His relationship to the woman placed him at risk of retaliation. CL fled shortly thereafter and has not returned since.",
  country: "Guatemala",
  deadline: "2024-03-16 19:47:39.385578+00", // timestamp (deadline to submit assignment)
  research_topic: "Cartel violence and operations in the area of Cuernavaca. Ties between cartel groups in the area and police/government. Police corruption and lack of investigation, impunity toward cartel groups that kidnap and murder in similar types of cases. Human rights violations in Mexico in general.",
